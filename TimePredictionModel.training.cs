...
{
    public partial class TimePredictionModel
    {
        public const string RetrainFilePath =  @"C:\Users\lavi_\Downloads\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"vendor_id", @"vendor_id", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"vendor_id",@"rate_code",@"passenger_count",@"trip_distance"}))      
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=1384,MinimumExampleCountPerLeaf=21,LearningRate=0.7982152648639592,LabelColumnName=@"trip_time_in_secs",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.99999999,L1Regularization=2E-10,L2Regularization=0.9847769342856236},MaximumBinCountPerFeature=250}));
